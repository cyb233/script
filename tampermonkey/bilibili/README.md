...
- [`bili.user.js`](./bili.user.js)：颜色标识 B 站收藏番剧作品更新状态  
  [README](./bili)
...
- [`emojis.user.js`](./emojis.user.js)：下载 Bilibili 直播间的 Emojis  
  [README](./emojis)

详细脚本说明请参见本目录下的脚本文档或根目录 [README](../../)。
